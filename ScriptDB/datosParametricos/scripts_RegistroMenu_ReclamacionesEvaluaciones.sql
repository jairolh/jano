...
VALUES ((SELECT MAX(id_pagina)+1 FROM jano_pagina),'evaluacionReclamacionesEvaluaciones','Página que permite gestionar la evaluaciones de las reclamaciones de las evaluaciones','Gestion Concurso','1','jquery=2.1.4.min&jquery-ui=true&jquery-validation=true&datatables=true&bootstrapcss=true&bootstrap=true   ');
...
VALUES ((SELECT  MAX(id_enlace)+1 cod FROM jano_enlace),'Modulo para la evaluación de las reclamaciones generales','Reclamaciones Evaluación', 'Enlace a la página para ver las reclamaciones', '', 'evaluacionReclamacionesEvaluaciones','');
...
(SELECT id_enlace FROM jano_enlace where etiqueta LIKE 'Reclamaciones Evaluación'),
