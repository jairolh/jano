...
(
  ...
  estado character varying(2) NOT NULL DEFAULT 'A'::character varying, 
  maximo_puntos numeric(8,2) NOT NULL, 
  porcentaje_aprueba numeric(8,2) NOT NULL DEFAULT 0,   	
...
(
  ...
  fecha_inicio character varying(20) ,
  fecha_fin character varying(20) ,
  fecha_fin_reclamacion character varying(20) ,
  fecha_fin_resolver character varying(20) ,
  estado character varying(2) NOT NULL DEFAULT 'A'::character varying,   	
  porcentaje_aprueba numeric(8,2) NOT NULL DEFAULT 0, 
  cierre character varying(20) ,
...
(
  ...
  maximo_puntos numeric(8,2) NOT NULL, 
  estado character varying(2) NOT NULL DEFAULT 'A'::character varying,
  puntos_aprueba numeric(8,2) NOT NULL DEFAULT 0, 
  ...
  CONSTRAINT fk_evaluar__relations_criterio FOREIGN KEY (consecutivo_criterio)
      ...
      ON UPDATE RESTRICT ON DELETE RESTRICT,
  CONSTRAINT fk_evaluar__relations_calendario FOREIGN KEY (consecutivo_calendario)
