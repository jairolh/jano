...
class Formulario {
    ...
    function formulario() {
        ...
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "Formulario y Estructura de la novedad Periodica";
        echo $this->miFormulario->marcoAgrupacion('inicio', $atributos); {
            ...
            echo $this->miFormulario->division("inicio", $atributos); {
                ...
                echo $this->miFormulario->marcoAgrupacion('inicio', $atributos); {
                    ...
                    echo "<tr><td>numPeriodos</td>";
                    echo "<td>Número de Periodos</td>";
                    echo "<td>Valor</td>";
                    echo "<td>Si</td>";
                    echo "<td>Si</td>";
                    echo "<td>XXXXX</td>";
                    
                    echo "<tr><td>uniPeriodos</td>";
                    echo "<td>Unidad de Periodos</td>";
                    echo "<td>Lista</td>";
                    echo "<td>Si</td>";
                    echo "<td>No</td>";
                    echo "<td>XXXXX</td>";
                    ...
                    echo "<tr><td>v_periodo</td>";
                    echo "<td>Valor por Periodo</td>";
                    echo "<td>Valor</td>";
                    echo "<td>Si</td>";
                    echo "<td>Si</td>";
                    echo "<td>XXXXX</td>";
