		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			
			{
				...
				if ($_REQUEST ['mensaje'] == 'inserto') {
					...
					$mensaje = "Registro Categoria Satisfactorio <br> Nombre: <h4>" . $_REQUEST ['nombreRegistro'] . "</h4>".
					"<br>Descripción: <h4>" . $_REQUEST ['estadoRegistro'] . "</h4>".
					"<br>Fecha Registro: " . date ( 'Y-m-d' );
					$mensaje .= "<br> Nuevo Categoría Registrada!";
					// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
				...
				if ($_REQUEST ['mensaje'] == 'modifico') {
					...
					$mensaje = "Modificacion Categoría Satisfactorio <br> Nombre: <h4>" . $_REQUEST ['nombreRegistro'] . "</h4>".
					"<br>Descripción: <h4>" . $_REQUEST ['codigoRegistro'] . "</h4>".
					"<br>Fecha Registro: " . date ( 'Y-m-d' );
					$mensaje .= "<br> Modificada Categoría!";
					// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
					$esteCampo = 'mensajeRegistro';
					$atributos ['id'] = $esteCampo;
					$atributos ['tipo'] = 'success';
