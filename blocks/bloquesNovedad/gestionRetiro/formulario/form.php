...
class Formulario {
    ...
    function formulario() {
		...
		$atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "GESTIÓN RETIROS";
		...
		echo '<table id="tablaReporte" class="display" cellspacing="0" width="100%"> ' . '<thead style="display: table-row-group"><tr><th>' . "DOCUMENTO" . '</th><th>' . "NÚMERO" . '</th> <th>' . "NOMBRES" . '</th> <th>' . "APELLIDOS" . '</th> <th>' . "FECHA INGRESO" . '</th><th>' . "FECHA RETIRO" . '</th><th>' . "VER DETALLE" . '</th><th>' . "INACTIVAR" . '</th></tr></thead>
