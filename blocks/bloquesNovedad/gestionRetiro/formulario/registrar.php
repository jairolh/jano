...
class Formulario {
    ...
    function formulario() {
        ...
        */
        ...
        $atributos ['titulo'] = true;//$this->lenguaje->getCadena ( $esteCampo );
		...
		echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
				...
				$atributos ["estilo"] = "jqueryui";
				$atributos ['tipoEtiqueta'] = 'inicio';
				$atributos ["leyenda"] = "Búsqueda de Empleados";
				echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
		...
		$valorCodificado .= "&opcion=opcForm";
		/**
