...
class Formulario {
    ...
    function formulario() {
       ...
       $miPaginaActual = $this->miConfigurador->getVariableConfiguracion('pagina');
        ...
        $_REQUEST['tipoLiquidacion'] = $resultado[$_REQUEST['variable']]['liquidacion'];
        ...
        $atributos ['validar'] = 'required,custom[onlyLetterSp],maxSize[30]';
        ...
        $cadenaSqlDetalle = $this->miSql->getCadenaSql("consultarLeyesTipoVinculacion", $_REQUEST['id']);
        ...
        echo $this->miFormulario->campoCuadroTexto($atributos);
        // --------------- FIN CONTROL : Cuadro de Texto --------------------------------------------------
        $cadenaSqlDetalle = $this->miSql->getCadenaSql("consultarRubros", $_REQUEST['id']);

        $matrizDatosRubros = $primerRecursoDB->ejecutarAcceso($cadenaSqlDetalle, "busqueda", $_REQUEST['id'], "consultarLeyesParametros");
