        ...
        if (isset($_REQUEST ['procesarAjax'])) {
            ...
            switch ($_REQUEST['opcion']) {
                ...
                case "registrar1.1":
                    ...
                    include_once ($this->ruta . "funcion/registrarContratista.php");

                    break;

                case "registrar1.2":

                    include_once ($this->ruta . "funcion/registrarVincEspecial.php");

                    break;
                case "registrar1":

                    include_once ($this->ruta . "funcion/registrar1.php");

                    break;
                case "registrar2":

                    include_once ($this->ruta . "funcion/registrar2.php");
