    ...
    function formulario() {
        ...
        if ($_REQUEST['opciones'] == 1) {
            ...
            $datos = array(
                ...
                'modelo_vinculacion' => 'Contratista'
            );
//     

            $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("modificarRegistro1", $datos);
            ...
            $atributos ['obligatorio'] = true;
            $atributos ['etiquetaObligatorio'] = true;
            $atributos ['validar'] = 'required, minSize[4], maxSize[15],custom[number]';
...
//            unset($atributos);
            ...
            $valorCodificado .= "&opcion=registrar1.1";
            /**
            ...
            $datos = array(
                'id' => $_REQUEST ['variable'],
                'modelo_vinculacion' => 'Vinculacion especial'
            );
//     
            ...
            $atributos ['obligatorio'] = true;
            $atributos ['etiquetaObligatorio'] = true;
            $atributos ['validar'] = 'required, minSize[2], maxSize[15],custom[onlyNumberSp]';
...
// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
            ...
            $atributos ['obligatorio'] = true;
            $atributos ['etiquetaObligatorio'] = true;
            $atributos ['validar'] = 'required, minSize[4], maxSize[15], custom[date]';
...
//            unset($atributos);
          ...
          // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
            ...
            $valorCodificado .= "&bloque=" . $esteBloque ['nombre'];
            $valorCodificado .= "&bloqueGrupo=" . $esteBloque ["grupo"];
            $valorCodificado .= "&opcion=registrar1.2";
            /**
             * SARA permite que los nombres de los campos sean dinámicos.
             * Para ello utiliza la hora en que es creado el formulario para
             * codificar el nombre de cada campo. 
