    ...
    function formulario() {
       ...
       // --------------------------------------------------------------------------------------------------
        ...
        $datos = array(
            ...
            'modelo_vinculacion'=> 'Vinculacion pensionados'
...
//     
	...
	$atributos ['tipoEtiqueta'] = 'inicio';
	$atributos ["leyenda"] = "Modelo de Vinculación Pensionado";
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
       ...
       // $valorCodificado  = "action=" . $esteBloque ["nombre"];
        ...
        $datos = array(
            'id' => $_REQUEST ['variable'],
            'modelo_vinculacion'=> 'Funcionario o Docente de planta'
...
//     
	...
	$atributos ["estilo"] = "jqueryui";
	$atributos ['tipoEtiqueta'] = 'inicio';
	$atributos ["leyenda"] = "Modelo de Vinculación Funcionario o Docente de Planta";
	echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );     
        ...
        // --------------- FIN CONTROL : Cuadro de Texto ------------
         unset($atributos);
          ...
          // --------------- inicio CONTROL : lista -------------
	        ...
	        $atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarCargo" );
       ...
       // $valorCodificado  = "action=" . $esteBloque ["nombre"];
        ...
        $valorCodificado .= "&bloque=" . $esteBloque ['nombre'];
        $valorCodificado .= "&bloqueGrupo=" . $esteBloque ["grupo"];
        $valorCodificado .= "&opcion=registrar1";
        /**
         * SARA permite que los nombres de los campos sean dinámicos.
         * Para ello utiliza la hora en que es creado el formulario para
         * codificar el nombre de cada campo. 
