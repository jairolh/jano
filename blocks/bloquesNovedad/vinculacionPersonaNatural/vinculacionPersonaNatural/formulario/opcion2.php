...
class Formulario {
    ...
    function formulario() {
       ...
       // --------------------------------------------------------------------------------------------------
		...
		$atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "Opciones de gestión";
        ...
        $atributos ['validar'] = 'required';
                 ...
                 $naturaleza = array( 
    array(1,'Modelo de Vinculacion Pensionado'), 
    array(2,'Modelo de Vinculacion Funcionario o Docente de Planta'), 
...
//       echo $this->miFormulario->marcoAgrupacion ( 'fin' );
        ...
        */
        ...
        $valorCodificado .= "&opcion=opcion2.1";
        /**
