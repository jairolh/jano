...
$('#<?php echo $this->campoSeguro('rubro')?>').width(200); 
$("#<?php echo $this->campoSeguro('rubro')?>").select2();

$('#<?php echo $this->campoSeguro('tipoVincu')?>').width(200); 
$("#<?php echo $this->campoSeguro('tipoVincu')?>").select2();
...
$('#<?php echo $this->campoSeguro('cargo')?>').width(200); 
