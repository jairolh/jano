		...
		echo $this->miFormulario->formulario ( $atributos );
		{
				...
				
			{
				...
				if ($_REQUEST ['mensaje'] == 'inserto') {
					...
					$mensaje = "Registro solicitud Satisfactorio <br> Razon social: <h4>" . $_REQUEST ['primerNombre'] . " </h4>".
							"<br>Apellidos: <h4>" . $_REQUEST ['primerApellido'] . " </h4>".
							"<br>Fecha Registro: " . date ( 'Y-m-d' );
					$mensaje .= "<br> Solicitud Registrada";
					// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
				...
				if ($_REQUEST ['mensaje'] == 'noInserto') {
					...
					$mensaje = "No Se Pudo Hacer Registro de la solicitud <br> Nombres: " . $_REQUEST ['primerNombre'] . 
					"<br>Apellidos:" . $_REQUEST ['primerApellido'] . "".
					"<br>Fecha Registro:" . date ( 'Y-m-d' );
