		...
		echo $this->miFormulario->formulario ( $atributos );
		{
				...
				
			{
				...
				if ($_REQUEST ['mensaje'] == 'inserto') {
					...
					$mensaje = "Registro solicitud Satisfactorio <br> Nombres: <h4>" . $_REQUEST ['primerNombre'] . " ".$_REQUEST ['segundoNombre']."</h4>".
				...
				if ($_REQUEST ['mensaje'] == 'noInserto') {
					...
					$mensaje = "No Se Pudo Hacer Registro de la solicitud <br> Nombres: " . $_REQUEST ['primerNombre'] . " ".$_REQUEST ['segundoNombre'].
