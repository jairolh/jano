...
class CambiarEstado {
    ...
    function procesarFormulario() {
        ...
        $parametro['id_tipo_jurado']=$_REQUEST['id_tipo_jurado'];
        $parametro['id_usuario']=$_REQUEST['id_usuario'];
        $this->cadena_sql = $this->miSql->getCadenaSql("cambiarEstadoJurado", $parametro);
        $resultadoEstado = $esteRecursoDB->ejecutarAcceso($this->cadena_sql, "acceso", $parametro, "actualizarEstadoJurado");
