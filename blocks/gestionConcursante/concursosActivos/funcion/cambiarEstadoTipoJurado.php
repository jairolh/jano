...
class CambiarEstado {
    ...
    function procesarFormulario() {
        ...
        $this->cadena_sql = $this->miSql->getCadenaSql("cambiarEstadoTipoJurado", $parametro);
        $resultadoEstado = $esteRecursoDB->ejecutarAcceso($this->cadena_sql, "acceso", $parametro, "actualizarEstadoTipoJurado");
