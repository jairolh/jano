			...
			unset ( $atributos );
			{
				...
				echo "<thead>
						...
						$mostrarHtml = "<tr align='center'>
										...
										$variableVerHoja .= "&consecutivo_concurso=".$resultadoInscripcion[0]['consecutivo_concurso'];
										$variableVerHoja .= "&consecutivo_perfil=".$resultadoInscripcion[0]['consecutivo_perfil'];
					 ...
					 $parametro=array(
						'consecutivo_concurso'=>$resultadoInscripcion[0]['consecutivo_concurso'],
						'consecutivo_perfil'=>$resultadoInscripcion[0]['consecutivo_perfil']
					 );
