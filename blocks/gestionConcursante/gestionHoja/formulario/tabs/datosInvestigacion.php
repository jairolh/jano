	...
	function miForm() {
		...
		$parametro['id_usuario']=$usuario;
                ...
                if(isset($_REQUEST['consecutivo_investigacion']))
                    {  $parametro['consecutivo_investigacion']=$_REQUEST['consecutivo_investigacion'];
		...
		$esteCampo = $esteBloque ['nombre'];
                $estefomulario= 'datosInvestigacion';
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			{	      
				...
				unset ( $atributos );
				{
                                    ...
                                    $atributos ['evento'] = ' ';
                                    if (isset ( $resultadoInvestigacion[0]['pais_investigacion'] ))
                                         {  $atributos ['seleccion'] = $resultadoInvestigacion[0]['pais_investigacion'];}
                                    ...
                                    // ---------------- CONTROL: Cuadro de Lista --------------------------------------------------------
                                    $esteCampo = 'nivel_institucion_investigacion';
                                    $atributos ['nombre'] = $esteCampo;
                                    $atributos ['id'] = $esteCampo;
                                    $atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
                                    $atributos ["etiquetaObligatorio"] = true;
                                    ...
                                    $atributos ['anchoEtiqueta'] = 170;
                                    $atributos ['evento'] = '';
                                    if (isset($resultadoInvestigacion[0]['codigo_nivel_institucion']))
                                         {  $atributos ['seleccion'] = $resultadoInvestigacion[0]['codigo_nivel_institucion'];}
                                    ...
                                    // ---------------- CONTROL: Cuadro de Lista --------------------------------------------------------
                                    $esteCampo = 'codigo_institucion_investigacion';
                                    $atributos ['nombre'] = $esteCampo;
                                    $atributos ['id'] = $esteCampo;
                                    $atributos ['etiqueta'] = $this->lenguaje->getCadena ( $esteCampo );
                                    $atributos ["etiquetaObligatorio"] = true;
                                    ...
                                    $atributos ['anchoEtiqueta'] = 170;
                                    $atributos ['evento'] = ' ';
                                    if (isset ( $resultadoInvestigacion[0]['codigo_institucion'] ))
                                         {  $atributos ['seleccion'] = $resultadoInvestigacion[0]['codigo_institucion'];}
                                    ...
                                    // ---------------- FIN CONTROL: Cuadro de Lista --------------------------------------------------------
                                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                                    $esteCampo = 'nombre_institucion_investigacion';
                                    $atributos ['id'] = $esteCampo;
                                    $atributos ['nombre'] = $esteCampo;
                                    $atributos ['tipo'] = 'text';
                                    $atributos ['estilo'] = 'jqueryui';
                                    ...
                                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                                    $esteCampo = 'correo_institucion_investigacion';
                                    $atributos ['id'] = $esteCampo;
                                    $atributos ['nombre'] = $esteCampo;
                                    $atributos ['tipo'] = 'text';
                                    $atributos ['estilo'] = 'jqueryui';
                                    ...
                                    // ---------------- FIN CONTROL: Cuadro de Texto --------------------------------------------------------
                                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                                    $esteCampo = 'telefono_institucion_investigacion';
                                    $atributos ['id'] = $esteCampo;
                                    $atributos ['nombre'] = $esteCampo;
                                    $atributos ['tipo'] = 'text';
                                    $atributos ['estilo'] = 'jqueryui';
                                    ...
                                    if (isset ( $resultadoInvestigacion[0]['telefono_institucion'] )) 
                                    ...
                                    // ---------------- FIN CONTROL: Cuadro de Texto --------------------------------------------------------                                      
                                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                                    $esteCampo = 'descripcion_investigacion';
                                    $atributos ['id'] = $esteCampo;
                                    $atributos ['nombre'] = $esteCampo;
                                    $atributos ['tipo'] = 'text';
                                    $atributos ['estilo'] = 'jqueryui';
                                    ...
                                    $atributos ['maximoTamanno'] = '';
                                    $atributos ['anchoEtiqueta'] = 170;
                                    if (isset ( $resultadoInvestigacion[0]['descripcion_investigacion'] )) {
                                            $atributos ['valor'] = $resultadoInvestigacion[0]['descripcion_investigacion'];
                                    } else {
                                            $atributos ['valor'] = '';
                                    }
                                    $tab ++;
                                    ...
                                    $atributos ['anchoEtiqueta'] = 170;
                                    $atributos ['evento'] = ' ';
                                    if (isset ( $resultadoInvestigacion[0]['actual'] ))
                                         {  $atributos ['seleccion'] = $resultadoInvestigacion[0]['actual'];}
                                    ...
                                    // ---------------- FIN CONTROL: Cuadro de Lista --------------------------------------------------------                                    
                                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                                    $esteCampo = 'fecha_inicio_investigacion';
                                    $atributos ['id'] = $esteCampo;
                                    $atributos ['nombre'] = $esteCampo;
                                    ...
                                    if (isset ( $resultadoInvestigacion[0]['fecha_inicio'] )) 
                                    ...
                                    // ---------------- FIN CONTROL: Cuadro de Texto --------------------------------------------------------
                                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                                    $esteCampo = 'fecha_fin_investigacion';
                                    $atributos ['id'] = $esteCampo;
                                    $atributos ['nombre'] = $esteCampo;
                                    $atributos ['tipo'] = 'texto';
                                    $atributos ['estilo'] = 'jqueryui';
                                    ...
                                    // ---------------- CONTROL: Cuadro de division --------------------------------------------------------
                                        ...
                                        unset ( $atributos );
                                                {
                                                    // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                                                    $esteCampo = 'soporteInvestigacion';
                                                    $atributos ['id'] = $esteCampo;
                                                    $atributos ['nombre'] = $esteCampo;
                                                    $atributos ['tipo'] = 'file';
                                                    $atributos ['estilo'] = 'jqueryui';
                                                  ...
                                                  if(isset($resultadoSopInv[0]['archivo']))
                                                        {
                                                           // ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
                                                          $esteCampo = 'archivoInvestigacion';
                                                          $atributos ['id'] = $esteCampo;
                                                          $atributos ['enlace'] = 'javascript:soporte("ruta_investigacion");';
                                                          $atributos ['tabIndex'] = 0;
                                                          $atributos ['marco'] = true;
                                                          $atributos ['columnas'] = 2;
                                                          $atributos ['enlaceTexto'] = $resultadoSopInv[0]['alias'];
				...
				unset ( $atributos );
				{
					...
					// -----------------FIN CONTROL: Botón -----------------------------------------------------------
                                    ...
                                    $docencia=isset($resultadoInvestigacion[0]['consecutivo_investigacion'])?$resultadoInvestigacion[0]['consecutivo_investigacion']:0;    
                                    $valorCodificado = "action=" . $esteBloque ["nombre"];
                                    $valorCodificado .= "&pagina=" . $this->miConfigurador->getVariableConfiguracion ( 'pagina' );
                                    $valorCodificado .= "&bloque=" . $esteBloque ['nombre'];
                                    $valorCodificado .= "&bloqueGrupo=" . $esteBloque ["grupo"];
                                    $valorCodificado .= "&opcion=guardarDatosInvestigacion";
...
$miSeleccionador = new investigacionForm ( $this->lenguaje, $this->miFormulario, $this->sql );
