...
class mensajeForm {
	...
	function miForm() {
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      		{
      			...
      			switch ($_REQUEST ['opcion']) {
      				case "inhabilitarActividad": 
      					$mensaje = "Esta seguro de Inhabilitar la Actividad <b>".$_REQUEST ['nombre_actividad']."</b>?";
      					$boton = "inhabilitarActividad";
      					break;
      				
      				case "habilitarActividad": 
      					$mensaje = "Esta seguro de habilitar la Actividad <b>".$_REQUEST ['nombre_actividad']."</b>?";
      					$boton = "habilitarActividad";
      					break;
             }
        ...
        $valorCodificado .= "&nombre_actividad=" .$_REQUEST['nombre_actividad'];
