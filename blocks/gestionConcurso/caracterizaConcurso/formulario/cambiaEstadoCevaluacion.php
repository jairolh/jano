...
class mensajeForm {
	...
	function miForm() {
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      		{
      			...
      			switch ($_REQUEST ['opcion']) {
      				case "inhabilitarCevaluacion": 
      					$mensaje = "Esta seguro de Inhabilitar el rol <b>".$_REQUEST ['rol']."</b> del criterio <b>".$_REQUEST ['criterio']."</b>?";
      					$boton = "inhabilitarCevaluacion";
      					break;
      				
      				case "habilitarCevaluacion": 
      					$mensaje = "Esta seguro de habilitar el rol <b>".$_REQUEST ['rol']."</b> del criterio <b>".$_REQUEST ['criterio']."</b>?";
      					$boton = "habilitarCevaluacion";
      					break;
             }
             
             $esteCampo = $_REQUEST['id_Cevaluacion'];
		...
		$valorCodificado .= "&opcion=".$boton;
                ...
                $valorCodificado .= "&id_Cevaluacion=" .$_REQUEST['id_Cevaluacion'];
