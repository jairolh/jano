...
class registrarForm {
	...
	function miForm() {
		...
		echo $this->miFormulario->formulario ( $atributos );
		{
			...
			//if(isset($_REQUEST['subsistema'])){$variableNvo.= "&subsistema=".$_REQUEST['subsistema'];}
            $variableNvo = $this->miConfigurador->fabricaConexiones->crypto->codificar_url ( $variableNvo, $directorio );
			//enlace nuevo subsistema
			...
			unset ( $atributos );
			{
					...
					$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarRolEvaluacion" );
					$matrizItems = $esteRecursoDB->ejecutarAcceso ( $atributos ['cadena_sql'], "busqueda" );
					$atributos ['matrizItems'] = $matrizItems;
					// Utilizar lo siguiente cuando no se pase un arreglo:
					// $atributos['baseDatos']='ponerAquiElNombreDeLaConexión';
