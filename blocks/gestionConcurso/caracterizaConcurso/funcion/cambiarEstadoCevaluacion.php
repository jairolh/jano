...
class CambiarEstado {
    ...
    function procesarFormulario() {
        ...
        $parametro['id_Cevaluacion']=$_REQUEST['id_Cevaluacion'];
        
        $this->cadena_sql = $this->miSql->getCadenaSql("cambiarEstadoCevaluacion", $parametro);
        $resultadoEstado = $esteRecursoDB->ejecutarAcceso($this->cadena_sql, "acceso", $parametro, "actualizarEstadoRolCriterio");
	if($resultadoEstado){
