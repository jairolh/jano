...
class mensajeForm {
	...
	function miForm() {
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      			{
                                    ...
                                    switch ($_REQUEST ['opcion']) {
                                        case "inhabilitarCalendario": 
                                                $mensaje = "Esta seguro de Inactivar la actividad <b>".$_REQUEST ['nombre']."</b> del calendario del Concurso ?";
                                                $estado = "I";
                                                $boton = "inhabilitar";
                                        break;        
                                        case "habilitarCalendario": 
                                                $mensaje = "Esta seguro de Activar la actividad <b>".$_REQUEST ['nombre']."</b> del calendario del Concurso ?";
                                                $estado= "A";
                                                $boton = "habilitar";
                                        break;
                                    }
		...
		$valorCodificado .= "&opcion=".$boton.'Calendario';
                $valorCodificado .= "&estadoCalendario=".$estado;
