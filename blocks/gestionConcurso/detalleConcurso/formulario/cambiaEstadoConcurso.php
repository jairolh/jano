...
class mensajeForm {
	...
	function miForm() {
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      			{
                                    ...
                                    switch ($_REQUEST ['opcion']) {
                                        case "inhabilitar": 
                                                $mensaje = "Esta seguro de Inactivar el concurso <b>".$_REQUEST ['nombre']."</b> ?";
                                                $estado = "I";
                                                $boton = "inhabilitar";
                                        break;        
                                        case "habilitar": 
                                                $mensaje = "Esta seguro de Activar el concurso <b>".$_REQUEST ['nombre']."</b> ?";
                                                $estado= "A";
                                                $boton = "habilitar";
                                        break;
                                    }
                                    
                                    $esteCampo = $_REQUEST['consecutivo_concurso'];
		...
		$valorCodificado .= "&opcion=".$boton;
                $valorCodificado .= "&estadoConcurso=".$estado;
