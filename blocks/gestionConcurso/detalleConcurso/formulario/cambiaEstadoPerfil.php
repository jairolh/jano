...
class mensajeForm {
	...
	function miForm() {
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      			{
                                    ...
                                    switch ($_REQUEST ['opcion']) {
                                        case "inhabilitarPerfil": 
                                                $mensaje = "Esta seguro de Inactivar el perfil <b>".$_REQUEST ['nombre']."</b> del Concurso ?";
                                                $estado = "I";
                                                $boton = "inhabilitar";
                                        break;        
                                        case "habilitarPerfil": 
                                                $mensaje = "Esta seguro de Activar el perfil <b>".$_REQUEST ['nombre']."</b> del Concurso ?";
                                                $estado= "A";
                                                $boton = "habilitar";
                                        break;
                                    }
		...
		$valorCodificado .= "&opcion=".$boton.'Perfil';
                $valorCodificado .= "&estadoPerfil=".$estado;
