...
class consultarForm {
	...
	function miForm() {
            ...
            $parametro=array('hoy'=>date("Y-m-d"),'jurado'=>$this->miSesion->getSesionUsuarioId(),'tipo'=>$find);
                    ...
                    //-----------------Inicio de Conjunto de Controles----------------------------------------
                        ...
                        foreach($resultadoConcurso as $key=>$value )
                            {   $parametro['tipo']='unico';
                                ...
                                //$variableDetalle = "pagina=evaluacionConcurso"; //pendiente la pagina para modificar parametro
