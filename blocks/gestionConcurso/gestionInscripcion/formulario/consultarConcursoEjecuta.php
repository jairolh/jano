...
class consultarForm {
	...
	function miForm() {
            ...
            unset ( $atributos );
                ...
                {   //listado columnas
                    $columnas = array('Código','Tipo Concurso','Modalidad','Nombre','Fecha Inicio','Fecha Fin','Acuerdo');
                            foreach ($resultadoTiposop as $tipokey => $value) 
                                {array_push($columnas, $resultadoTiposop[$tipokey]['alias']);}
                            array_push($columnas,'Inscritos','Consulta');	
                    //-----------------Inicio de Conjunto de Controles----------------------------------------
                        ...
                        $mostrarHtml.= "<td>".$resultadoConcurso[$key]['inscritos']."</td>   
                                        <td>";
                                                $esteCampo = "detalle";
                                                $atributos["id"]=$esteCampo;
