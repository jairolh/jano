...
class mensajeForm {
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      		{
      			...
      			switch ($_REQUEST ['opcion']) {
      				case "inhabilitarCriterio":
      					$mensaje = "Esta seguro de Inhabilitar el Criterio <b>".$_REQUEST ['nombre_criterio']. "</b> para el tipo de Jurado <b>" .$_REQUEST ['nombre_tipo']."</b>?";
      					$boton = "inhabilitarCriterio";
      					break;

      				case "habilitarCriterio":
      					$mensaje = "Esta seguro de habilitar el Criterio <b>".$_REQUEST ['nombre_criterio']."</b> para el tipo de Jurado<b>" .$_REQUEST ['nombre_tipo']."</b>?";
      					$boton = "habilitarCriterio";
      					break;
             }
    ...
    $valorCodificado .= "&id_tipo=" .$_REQUEST['id_tipo'];
    $valorCodificado .= "&nombre_tipo=" .$_REQUEST['nombre_tipo'];
