...
class mensajeForm {
			...
			echo $this->miFormulario->marcoAgrupacion ( 'inicio', $atributos );
      		{
      			...
      			switch ($_REQUEST ['opcion']) {
      				case "inhabilitarTipoJurado":
      					$mensaje = "Esta seguro de Inhabilitar el Tipo de Jurado <b>".$_REQUEST ['nombre_tipoJurado']."</b>?";
      					$boton = "inhabilitarTipoJurado";
      					break;

      				case "habilitarTipoJurado":
      					$mensaje = "Esta seguro de habilitar el Tipo de Jurado <b>".$_REQUEST ['nombre_tipoJurado']."</b>?";
      					$boton = "habilitarTipoJurado";
      					break;
             }
    ...
    $valorCodificado .= "&id_tipoJurado=" .$_REQUEST['id_tipoJurado'];
    $valorCodificado .= "&nombre_tipoJurado=" .$_REQUEST['nombre_tipoJurado'];
