...
class consultarContacto{
	...
	function miForm() {
            ...
            $atributos ["leyenda"] = "".$this->lenguaje->getCadena ( $esteCampo )." - ".$datos[0]['nombre']." ".$datos[0]['apellido'];
                    ...
                    {	$cajaNombre="width='15%'";
                        ...
                        $mostrarHtml.= " <tbody>";
                                ...
                                $mostrarHtml.= "<tr align='center'>
                                                        ...
                                                        <td class='table-tittle estilo_tr ' $cajaDato>".$datos[0]['pais']."</td>
                                                        <th class='textoAzul' $cajaNombre>".$this->lenguaje->getCadena ('ciudad_residencia')."</th>
                                                        <td class='table-tittle estilo_tr ' $cajaDato>".$datos[0]['ciudad']."</td>  </tr> ";
                                $mostrarHtml.= "<tr align='center'>
                                                        <th class='textoAzul' $cajaNombre>".$this->lenguaje->getCadena ('direccion_residencia')."</th>
                                                        <td colspan=3 class='table-tittle estilo_tr ' $cajaDato>".$datos[0]['direccion_residencia']."</td>
                                                        </tr> ";
                                $mostrarHtml.= "<tr align='center'>
                                                        <th class='textoAzul' $cajaNombre>".$this->lenguaje->getCadena ('telefono')."</th>
                                                        <td class='table-tittle estilo_tr ' $cajaDato>".$datos[0]['telefono']."</td>
