                                                                ...
                                                                <td align='left'>";
                                                                 $mostrarHtml.=  "<table id='tablaReclamos' class='table table-striped table-bordered'>
                                                                            ...
                                                                            foreach ($resultadoReclamo as $recl => $value) 
                                                                                           {
                                                                                           $mostrarHtml.= "<tr>";
                                                                                           $mostrarHtml.= "<td>".$resultadoReclamo[0]['id_evaluador']."</td> ";
                                                                                           $mostrarHtml.= "<td>".$resultadoReclamo[0]['id_rsta']."</td> ";
                                                                                           $mostrarHtml.= "<td>".$resultadoReclamo[0]['resultado']."</td> ";
                                                                                           $mostrarHtml.= "<td>".$resultadoReclamo[0]['observacion']."</td> ";
                                                                                           $mostrarHtml.= "</tr>";
                                                                                           }
                                                                    $mostrarHtml.= "  </table>"; 
                                               $mostrarHtml.= "  </td>";                     
