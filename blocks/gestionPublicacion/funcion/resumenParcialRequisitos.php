...
$cadena_sql = $this->sql->getCadenaSql("listadoParcialRequisitos", $parametro);
...
$paginaHeader.="    <tr>
                        <td align='center'>
                            <span style='font-size:9.0pt;'>
                             Lista de resultados - Fecha Cierre ".$_REQUEST['cierre']."
                            </span>
                        </td>
                    </tr> ";
$paginaHeader.= " </tbody>";
...
foreach($resultadoListaFase as $key=>$value )
   {           
    ...
    $contenido .= "   <td width='170' align='justify'><span style='font-size:6pt;'>".$resultadoListaFase[$key]['observacion']."</span></td>";        
    $contenido .= "   </tr>";
    }
