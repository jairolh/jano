...
$paginaHeader.="    <tr>
                        <td align='center'>
                            <span style='font-size:9.0pt;'>
                             Lista de resultados reclamaciones de evaluación - Fecha cierre ".$_REQUEST['cierre']."
                            </span>
                        </td>
                    </tr> ";
...
$anchoCriterio=(600/(count($criterioFase)+2));
...
foreach($resultadoListaFase as $key=>$value )
   {           
    ...
    $contenido .= "   <td width='125' align='justify'><span style='font-size:7.5pt;'>".$resultadoListaFase[$key]['perfil']."</span></td>";        
    ...
    $contenido .= "   <td width='135' align='left'><span style='font-size:7.5pt;'>".$resultadoListaFase[$key]['nombre']." ".$resultadoListaFase[$key]['apellido']."</span></td>";
    ...
    if($_REQUEST['puntos_aprueba']>0 && $resultadoListaFase[$key]['puntaje_promedio']>=$_REQUEST['puntos_aprueba'])
        {$contenido .= "   <td width='55' align='justify'><span style='font-size:7.5pt;color:green'>Continúa</span></td>"; }       
    elseif ($_REQUEST['puntos_aprueba']>0)
        {$contenido .= "   <td width='55' align='justify'><span style='font-size:7.5pt;color:red'> No continúa</span></td>"; }         
    $contenido .= "   </tr>";
    }
