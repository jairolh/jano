...
foreach($resultadoListaFase as $key=>$value )
   {           
    ...
    $contenido .= "   <td width='180' align='left'><span style='font-size:7.0pt;'>".$resultadoListaFase[$key]['nombre']." ".$resultadoListaFase[$key]['apellido']."</span></td>";
    $contenido .= "   <td width='40'  align='center'><span style='font-size:7.0pt;'>".$resultadoListaFase[$key]['id_reclamacion']."</span></td>";        
    $contenido .= "   <td width='60'  align='center'><span style='font-size:7.0pt;'>".ucwords(strtolower($resultadoListaFase[$key]['cumple_requisito']))." cumple</span></td>";        
