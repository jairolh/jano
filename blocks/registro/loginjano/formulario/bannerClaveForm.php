...
class cabecera {
    ...
    function estructura() {
        ...
        echo $this->miFormulario->division("inicio", $atributos); {
            ...
            $atributos ['id'] = $esteCampo;
            $atributos['imagen'] = $this->miConfigurador->getVariableConfiguracion('host') .$this->miConfigurador->getVariableConfiguracion('site') . '/blocks/gui/bannerUsuario/css/images/bannerTitan2.jpg';
