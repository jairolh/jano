    ...
    */
    ...
    //$q->initial_project = "<project>";          
     if(isset($_REQUEST['project']) && $_REQUEST['project']!='')
        {$q->initial_project = $_REQUEST['project'];  }
    ...
    if(isset($_REQUEST['xmlin']) && $_REQUEST['xmlin']!='')
       { $q->initial_report = $_REQUEST['xmlin'];}
    ...
    //$q->initial_execute_mode = "<MODE>";
     if(isset($_REQUEST['execute_mode']) && $_REQUEST['execute_mode']!='')
        { $q->initial_execute_mode = $_REQUEST['execute_mode'];}
    ...
    $q->access_mode = $_REQUEST['access_mode'];
