...
class RegistradorPerfil {
	...
	$arregloDatos = array('id_subsistema'=>$_REQUEST['id_subsistema'],
        ...
        $resultadoSub = $esteRecursoDB->ejecutarAcceso($this->cadena_sql, "actualizar", $arregloDatos, "EditarSubsistema" );
        
        $this->cadena_sql = $this->miSql->getCadenaSql("EditarRol", $arregloDatos);
        $resultadoRol = $esteRecursoDB->ejecutarAcceso($this->cadena_sql, "actualizar", $arregloDatos, "EditarRol" );
