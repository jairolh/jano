...
?>
        ...
        $("#gestionRoles").validationEngine({
            promptPosition : "centerRight", 
            scroll: false
        });

        $(function() {
            $("#gestionRoles").submit(function() {
                $resultado=$("#gestionRoles").validationEngine("validate");
                if ($resultado) {
...
$('#<?php echo $this->campoSeguro('paginaSub')?>').width(210);
$("#<?php echo $this->campoSeguro('paginaSub')?>").select2();
<?php 
//}
